#############################################################################
# Makefile for building: encrypt_gui.app/Contents/MacOS/encrypt_gui
# Generated by qmake (3.1) (Qt 6.9.1)
# Project:  encrypt_gui.pro
# Template: app
# Command: /opt/homebrew/opt/qt/bin/qmake -o Makefile encrypt_gui.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = encrypt_gui1.0.0
DISTDIR = /Users/bissojitsarker/Desktop/Github\ Projects/File_Encryption_Decryption/.tmp/encrypt_gui1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		encrypt_gui.pro encryption.h main.cpp \
		encryption.cpp
QMAKE_TARGET  = encrypt_gui
DESTDIR       = 
TARGET        = encrypt_gui.app/Contents/MacOS/encrypt_gui

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/bissojitsarker/Desktop/Github Projects/File_Encryption_Decryption/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/bissojitsarker/Desktop/Github Projects/File_Encryption_Decryption/encrypt_gui.pro
...
encrypt_gui.app/Contents/MacOS/encrypt_gui:  $(OBJECTS)  
	@test -d encrypt_gui.app/Contents/MacOS/ || mkdir -p encrypt_gui.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: encrypt_gui.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile encrypt_gui.pro
...
encrypt_gui.app/Contents/PkgInfo: 
	@test -d encrypt_gui.app/Contents || mkdir -p encrypt_gui.app/Contents
	@$(DEL_FILE) encrypt_gui.app/Contents/PkgInfo
	@echo "APPL????" > encrypt_gui.app/Contents/PkgInfo
encrypt_gui.app/Contents/Info.plist: 
	@test -d encrypt_gui.app/Contents || mkdir -p encrypt_gui.app/Contents
	@$(DEL_FILE) encrypt_gui.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.encrypt-gui,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.encrypt-gui,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,encrypt_gui,g" -e "s,@LIBRARY@,encrypt_gui,g" -e "s,\$${EXECUTABLE_NAME},encrypt_gui,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >encrypt_gui.app/Contents/Info.plist

all: Makefile \
		encrypt_gui.app/Contents/PkgInfo \
		encrypt_gui.app/Contents/Info.plist encrypt_gui.app/Contents/MacOS/encrypt_gui
...
distdir: FORCE
	...
	$(COPY_FILE) --parents encryption.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp encryption.cpp $(DISTDIR)/
